...
- Área común: Se dejó la zona izquierda de la pantalla para incluir el calendario, el correo y las diferentes asignaturas, de manera que estubieran siempre accesibles desde cualquier página de la aplicación.
...
Todos estos detalles se pueden apreciar en la siguiente imagen, que muestra la página incial de una de las asignaturas.
(INSERTAR CAPTURA PENCIL)
